        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="font-display text-3xl font-extrabold tracking-tight text-text-primary flex items-center gap-2">
              <BarChart3 className="text-accent-blue" /> Draft Insights & Analytics
            </h1>
            <p className="text-sm text-text-secondary">
              Real-time graphs, budget allocation analytics, and squad comparisons.
            </p>
          </div>
          <button
            onClick={fetchStats}
          ...
          >
            <Activity size={14} className="text-accent-blue" /> Refresh Stats
          </button>
        </div>
